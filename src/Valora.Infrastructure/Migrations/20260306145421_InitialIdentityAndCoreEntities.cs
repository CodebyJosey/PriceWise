...
{
    /// <inheritdoc />
    public partial class InitialIdentityAndCoreEntities : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PredictedPrice = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoryKey = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    FeaturesJson = table.Column<string>(type: "text", nullable: false),
                    PredictedPrice = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DatasetPath = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: false),
                    ModelPath = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: false),
                    RSquared = table.Column<double>(type: "double precision", nullable: false),
                    RootMeanSquaredError = table.Column<double>(type: "double precision", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PredictionRecords_CategoryKey",
                table: "PredictionRecords",
                column: "CategoryKey");

            migrationBuilder.CreateIndex(
                name: "IX_PredictionRecords_CreatedAtUtc",
                table: "PredictionRecords",
                column: "CreatedAtUtc");

            migrationBuilder.CreateIndex(
                name: "IX_PredictionRecords_UserId",
                table: "PredictionRecords",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_TrainingRuns_CategoryKey",
                table: "TrainingRuns",
                column: "CategoryKey");

            migrationBuilder.CreateIndex(
                name: "IX_TrainingRuns_CategoryKey_Version",
                table: "TrainingRuns",
                columns: new[] { "CategoryKey", "Version" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TrainingRuns_CreatedAtUtc",
                table: "TrainingRuns",
                column: "CreatedAtUtc");
